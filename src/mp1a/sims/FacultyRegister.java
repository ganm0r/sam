...
public class FacultyRegister extends JFrame implements ActionListener
{
    JTable t1;
    JButton b1;
    String col[] = {"EMP ID", "Date/Time", "Status"};
    String tab[][] = new String[70][4];
    int i = 0, j = 0;
    
    public FacultyRegister()
    {
        super("Attendance Register - Faculty");
        setSize(1040, 760);
        setLocation(400, 180);

        try
        {
            String q = "select * from faculty_attendance";
            conn co = new conn();
