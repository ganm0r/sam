...
public class StudentAttendance extends JFrame implements ActionListener
{
    ...
    {
        super("Attendance - Student Attendance");
        setSize(1040, 760);
        setLocation(400, 180);
        setLayout(null);
        ...
        l1 = new JLabel("Mark Student Attendance");
        ...
        {
            conn co = new conn();
            ResultSet rs = co.s.executeQuery("select * from student");
            while(rs.next())
            {   
                ch.add(rs.getString("xieid"));
            }
        }
        catch(Exception e)
        {
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String q = "insert into student_attendance values('"+id+"','"+d+"','"+st+"')";
