...
public class StudentDetails extends JFrame implements ActionListener
{
    ...
    JButton b1, b2;
    JTextField tx;
    String col[] = {"XIE ID", "Name", "Branch", "Email ID"};
    String tab[][] = new String[70][4];
    int i = 0, j = 0;
    
    public StudentDetails()
    {
        super("Personnel Info - Students");
        setSize(1040, 760);
        setLocation(400, 180);
        setLayout(null);

        l1 = new JLabel("Delete Student(Enter XIE ID)");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == b1)
        {
            ...
            {   
                ...
                String q = "delete from student where xieid = '"+st+"'";
